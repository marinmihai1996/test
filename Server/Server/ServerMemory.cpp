...
{
	string path = "C:/Users/Marin/Documents/git/test/Server/Server/";
...
void Memory::RestoreAccountList() {
	...
	string line;
	ifstream myfile("C:/Users/Marin/Documents/git/test/Server/Server/Accounts.txt");
	if (myfile.good()){
...
void Memory::RestoreGroupsList() {
		...
		string line;
		ifstream myfile("C:/Users/Marin/Documents/git/test/Server/Server/Groups.txt");
		if (myfile.good()) {
			while (getline(myfile, line)) {  
				vector<string>tokens = split(line, ' ');
...
{
	fstream ofs;
	ofs.open("C:/Users/Marin/Documents/git/test/Server/Server/Accounts.txt", ios::out | ios::trunc);
	ofs.flush();
	ofs.close();
